      ...
      <div className="min-h-screen bg-gradient-to-br from-green-800 to-green-950 p-3 md:p-4">
        <div className="max-w-6xl mx-auto space-y-3 md:space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6">
              ...
              <div className="flex-1 min-w-0">
                ...
                <MeldedCombinations
                  ...
                  onDropOnCombination={handleDropOnCombination}
                  onSubstituteJoker={handleDropSubstituteJoker}
                />
              </div>
            </div>
          </div>
          ...
          <PlayerHand
            ...
            onDragCardStart={(card) => setDraggedCard(card)}
            onDragCardEnd={() => setDraggedCard(null)}
